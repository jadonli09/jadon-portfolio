...
export function CourtBanner() {
  const stats = [
    { to: 1, suffix: "st", label: "In School History", prefix: "" },
    { to: 1, suffix: "st", label: "In District History", prefix: "" },
    { to: 5, suffix: "", label: "Starters — First Five", prefix: "#" },
    { to: 500, suffix: "k+", label: "DouYin Likes", prefix: "" },
  ] as const;
